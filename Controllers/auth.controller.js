...
/*
@FORGOT_PASSWORD
@route hhtp://localhost:5000/api/auth/forgot
...
export const forgotPassword = asyncHandler(async (req, res) => {
  ...
  const resetUrl = `${req.protocol}://${req.get(
    "host"
  )}/api/auth/password/reset/${resetUrl}`;
...
/*
@RESET_PASSWORD
@route hhtp://localhost:5000/api/auth/password/reset/:resetToken
...
export const resetPassword = asyncHandler(async (req, res) => {
  ...
  //helper method for cookie can ne added
  res.cookie("token", token, cookieOptions);
  res.status(200).json({
    success: true,
    user,
...
@GET_PROFILE
@REQUEST_TYPE GET
@route hhtp://localhost:5000/api/auth/profile
